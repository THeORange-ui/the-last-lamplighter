...
ACTIONS: dict[str, str] = {
    ...
    "request_help": (
        ...
        "        themselves. \"fetch\" ends the moment they are holding it; \"deliver\"\n"
        "        ends when it is in the named person's hands — and that person may be\n"
        "        YOU. If you want something brought back to you, it is deliver with your\n"
        "        own id as \"npc\", or it finishes before they have walked to you.\n"
