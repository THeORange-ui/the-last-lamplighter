...
def _system(char: dict, goal: dict | None) -> str:
    ...
    return (
        ...
        f"# Tonight\n"
        f"It is night in Emberhold. The player is asleep at the waystation and nobody "
        ...
        "Plenty of nights people simply sleep, and that is a fine answer — return an "
        "empty list if you would honestly do nothing tonight.\n"
        "But **if you do act, the act should leave something the player can pick up.** "
        "Walking somewhere and saying nothing about why is, from everybody else's side "
        "of it, the same as not acting at all. So when you move, ask: is there something "
        "I now want their hands for? If there is, ask for it in the same breath. That is "
        "usually the whole point of having moved.\n"
        "Sending word on its own is the emptiest thing on this list — it costs you "
        "nothing and changes nothing. Don't let it be your whole night.\n\n"
